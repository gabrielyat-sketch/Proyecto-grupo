 ...
 *
 * El contrato se genera desde los mismos decoradores que validan la entrada y
 * declaran la salida, asi que no puede desincronizarse del codigo: si alguien
 * agrega un endpoint y olvida documentarlo, aparece igual; y si cambia un DTO,
 * el contrato cambia con el.
 *
...
import { construirDocumentoOpenApi } from '@cap/shared';
...
async function main(): Promise<void> {
  ...
  console.log(
    'Contrato de ' + env.NOMBRE_SERVICIO + ': ' + rutas + ' rutas, ' + operaciones +
      ' operaciones, ' + esquemas + ' esquemas',
  );
  console.log('  -> ' + destino);
